...
private:
	...
	const std::string m_config_file_name{ CONFIG_FILE_NAME };
...
protected:
	...
	void PushBuiltInPlugin(const std::string& server_type, std::vector<std::shared_ptr<PluginData>>& vec_plugin_data);
public:
